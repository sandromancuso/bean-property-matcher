...
public class BeanPropertyMatcher<T> extends TypeSafeDiagnosingMatcher<T> {
	...
	private Object getPropertyValue(Object parentObject, String memberObjectProperty) throws Exception {
        PropertyDescriptor property = PropertyUtil.getPropertyDescriptor(memberObjectProperty, parentObject);
    ...
    private Method findReadMethod(Object argument, String propertyName, Description mismatchDescription) throws IllegalArgumentException {
        PropertyDescriptor propertyDescriptor = PropertyUtil.getPropertyDescriptor(propertyName, argument);
